      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                Information generated by CAREQ is advisory and must be reviewed by a qualified healthcare professional. 
                CAREQ <strong className="text-white underline decoration-amber-400">does not diagnose conditions or prescribe treatment</strong>. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-6 border-b border-[#163B66]">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-white text-base tracking-tight">CAREQ</span>
              <span className="text-[10px] text-teal-300 uppercase tracking-widest bg-white/10 px-1.5 py-0.5 rounded">Digital Health</span>
            </div>
            <p className="text-slate-300 leading-relaxed text-[11px]">
              AI-assisted digital health triage support platform designed to organize patient-provided information for review by authorized healthcare professionals.
            </p>
            <div className="flex items-center gap-1.5 text-[11px] text-teal-300 font-semibold pt-1">
              <Shield className="w-3.5 h-3.5" />
              <span>Digital Public Health Interoperability Ready</span>
            </div>
          </div>

          {/* Col 2: Core Experiences */}
          <div>
            <h4 className="font-bold text-white uppercase text-[11px] tracking-wider mb-2.5">Platform Experiences</h4>
            <ul className="space-y-1.5 text-slate-300 text-xs">
              <li>
                <button onClick={() => navigate('/login')} className="hover:text-white transition-colors">
                  Digital Health Gateway (Auth)
                </button>
              </li>
              <li>
                <button onClick={() => navigate('/patient/dashboard')} className="hover:text-white transition-colors">
                  Patient Health Overview & Intake
                </button>
              </li>
              <li>
                <button onClick={() => navigate('/doctor/dashboard')} className="hover:text-white transition-colors">
                  Clinical Review Workspace (Doctor)
                </button>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-bold text-white uppercase text-[11px] tracking-wider mb-2.5">Emergency Triage Notice</h4>
            <div className="bg-red-950/40 border border-red-800/60 rounded-careq-md p-3 text-xs space-y-1.5">
              ...
              <p className="text-[11px] text-red-200 leading-tight">
                For acute chest pain, severe dyspnea, or trauma, bypass digital intake and dial emergency response:
              </p>
              <div className="flex gap-2 pt-1 font-mono font-bold text-xs text-white">
                <span className="bg-red-800 px-2 py-0.5 rounded">108 (Ambulance)</span>
                <span className="bg-red-800 px-2 py-0.5 rounded">112 (National)</span>
              </div>
            </div>
          </div>
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-slate-400 text-[11px]">
          ...
          <div className="flex items-center gap-4">
            ...
            <span>•</span>
            <span className="hover:text-slate-300 cursor-pointer" onClick={() => setPrivacyModalOpen(true)}>Data Governance</span>
            <span>•</span>
            <span className="hover:text-slate-300 cursor-pointer" onClick={() => navigate('/verify')}>Demonstration Credentials</span>
          </div>
        </div>
